    ...
    def train(self):
        ...
        for i_episode in range(100):
            ...
            while True:
                ...
                error, self.r2 = vrep.simxGetObjectHandle(clientID, 'body#7', vrep.simx_opmode_blocking)
                ...
                reward = 100*(distance < 0.15) - 10*(distance > 1 or np.abs(z2-z1) > 0.2) - 0.1*self.steps 
                #################################
                #print("R: ", reward)
