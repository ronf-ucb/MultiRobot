...
class Pursuit:
    def __init__(self, leftName, rightname):
        ...
        self.sub_path = rospy.Subscriber("/cockroachPath_former", Vector3, self.getPath, queue_size=1)
        self.sub_r_pos = rospy.Subscriber("/cockroachPos_former", Point32, self.getPos, queue_size=1)
        self.pub_vel = rospy.Publisher("/cockroachVel_former", Vector3, queue_size = 1)
        self.pub_pathNum = rospy.Publisher("/pathNum_former", Vector3, queue_size = 1)
        self.pub_stop = rospy.Publisher("/cockroachFlag_former",Vector3,queue_size = 1)
